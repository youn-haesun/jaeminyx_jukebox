...
def setup_dist_from_mpi(
    ...
    print('Jaeminyx jukebox: CUDA 11 / CPU 병렬학습 지원 Jukebox.')
    print('최소 요구 GPU RAM: 6GB, 오리지널 Jukebox는 16GB 정도를 요구하고 퀄리티를 위해서는 그렇게 하는게 좋습니다.')
    print()
    print('Colab에서 구동시, GPU가 K80이 아닌 T4 / P100 둘 중 하나인 지 꼭 확인 후 구동해야 합니다.')
